<!--
URL: 
http://totalfitnessforce.com/technology.php/_CONT_TEC/cont_1/cont_first.php
...
header ("Location:promoApps.html?link='promo/promoApps'");
...
$url='http://totalfitnessforce.com/technology.php/_CONT_TEC/cont_1/cont_first.php';
...
$cont_first='_CONT_TEC/'.$N_cont_tec.'/cont_first.php';
$article1='';
 $article2='';
}
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-548700096a1bc4dc" async="async"></script>
		...
		<div id="nave">
		<?
                       include("zini_hour_tec.php");
                        include("zini.php");


                          $dir_publi='_PUBLI_TEC';
                          $dir_cont='_CONT_TEC/'.$N_cont_tec.'';
