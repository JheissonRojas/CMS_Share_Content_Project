...
$menu_wtf='';
$menu_curio='';
$menu_store='class="active"';
$menu_health='';
$menu_knowing='';



$dir_publi='_PUBLI_STORE';
$dir_cont='_CONT_STORE';
...
$cont_first="_CONT_STORE/_store_begin.php";
$article1='';
 $article2='';
}
...
-->
		...
		.art-content .art-postcontent-0 .layout-item-2 { border-right-style:solid;border-right-width:1px;border-right-color:#87D237; padding-right: 2px;padding-left: 2px;  }
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5487694f03608afa" async="async"></script>
		...
		<!--PUBLI-0-->						
				<div class="art-layout-cell layout-item-0" style="width: 100%" >
					<p style="text-align: center;"><span style="color: rgb(54, 69, 55); font-family: 'Comic Sans MS'; font-size: 26px; text-align: center;"><? include("zphrase.php"); ?></span><br></p>
				</div>  
		<!--PUBLI-0-->		
		<!--###0-->		
		</div>
