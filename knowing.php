...
URL:
http://wwww.totalfitnessforce.com/knowing.php/_CONT_KNOWING/cont_1/cont_first.php



-->
<?
$url='http://wwww.totalfitnessforce.com/knowing.php/_CONT_KNOWING/cont_1/cont_first.php';
...
$menu_store='';
$menu_health='';
$menu_knowing='class="active"';


include("zini_hour_kno.php");
include("zini.php");


$dir_publi='_PUBLI_KNOWING';
$dir_cont='_CONT_KNOWING/'.$N_cont_kno.'';
...
$cont_first='_CONT_KNOWING/'.$N_cont_kno.'/cont_first.php';
$article1='';
 $article2='';
}
...
.art-content .art-postcontent-0 .layout-item-5 { padding-right: 4px;padding-left: 4px; padding-top: 10px; padding-bottom: 30px}
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-54c9523a2b7c1a18" async="async"></script>
...
<!-- $$$$$$$$$$$$$$$$$$$$$$$$$$$$ LINKS  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$--> 
	...
	<?php
		include (''.$dir_cont.'/links_content_right_1.php');
	?>	
