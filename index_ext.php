...
$cont_first="_CONT_TFF/cont_1/cont_first.php";
$article1='';
 $article2='';
}
...
-->
		...
		<!--INDEX-7-->
			...
			<div class="art-layout-cell layout-item-2" style="width: 16%" >
				...
				<ul>
				<li><a href="htttp://wwwww" style="font-size: 16px; ">Fitness Nutrition</a><span style="line-height: normal; font-size: 16px;"></span></li>
				<li><a href="htttp://wwwww" style="font-size: 16px;">Gatgets</a><span style="font-size: 16px;"><br></span></li>
				<li><a href="htttp://wwwww" style="font-size: 16px;">Curiosities</a></li>
				<li><a href="#" style="font-size: 16px;">Girls</a><br></li>
				<li><a href="http://www." style="font-size: 16px;">Boys</a><br></li>
				<li><a href="http://www." style="font-size: 16px;">Gifts</a><br></li>
				<li><a href="http://www." style="font-size: 16px;">Office</a></li>
				<li><a href="http://www." style="font-size: 16px;">Pets</a><br></li>
				<li><a href="http://www." style="font-size: 16px;">Best Sellers</a></li>
				</ul>
