...
include("zini_hour_tff.php");
include("zini.php");


$dir_publi='_PUBLI_TFF';
$dir_cont='_CONT_TFF/'.$N_cont_tff;
/*
$cont_act=0;
$cont_act=include($dir_cont."/Num_article.php");
echo "$cont_act <br>";
$tit_act="tit_".$cont_act.".php";
echo "$tit_act <br>";
$var_tit=include($dir_cont."/".$tit_act);
echo "$var_tit <br>";
*/
...
$cont_first='_CONT_TFF/'.$N_cont_tff.'/cont_first.php';
$article1='';
 $article2='';
}
	...
	<!--<script language="JavaScript">-->
		...
		<!-- $$$$$$$$$$$$$$$$$$$$$$$$$$$$  FIRST BLOCK BODY  PUBLI  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ -->
			...
			<div class="art-layout-cell layout-item-4" style="width: 15%" >
				<p  style="text-align: center;"> </p>	
				<p><span style="color: rgb(107, 170, 39); font-family: 'Comic Sans MS'; font-size: 20px;">Interesting</span></p>
