<!--
URL: 
http://wwww.totalfitnessforce.com/curious.php/_CONT_CURIO/cont_1/cont_first.php


-->
<?

$url='http://wwww.totalfitnessforce.com/curious.php/_CONT_CURIO/cont_1/cont_first.php';
...
include("zini_hour_cur.php");
include("zini.php");


$dir_publi='_PUBLI_CURIO';
$dir_cont='_CONT_CURIO/'.$N_cont_cur.'';



if($_GET['link']){
 $cont_first=$_GET['link'];
 //$article1=''; //to recive other variable
 //$article2='';
	 //if($_GET['link_a']){
...
$cont_first='_CONT_CURIO/'.$N_cont_cur.'/cont_first.php';
//$article1='';
// $article2='';
}
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-54871bef7258bf99" async="async"></script>
